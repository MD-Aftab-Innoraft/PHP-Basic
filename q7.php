...
<body>
    <div class="container">
        ...
        <ul>
            <li>Login page opens if not logged in
                <ul>
                    <li>Once I login, I should be redirected to the Question No.4 page</li>
                </ul>
            </li>
            <li>Question No. 4 page opens directly if I am logged in </li>
        </ul>
